    ...
    <>
      ...
      <div className="grid grid-flow-col grid-rows-2 md:grid-cols-4 gap-8 max-h-[720px]">
        ...
        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 md:static md:ml-96 md:mt-10 md:bottom-auto">
          <button
            className="border-gray-400 rounded mt-36"
            onClick={togglePoppup}
          >
            <span className="py-5 px-4 text-gray-900 focus:outline-none text-white bg-orange-400 hover:bg-orange-500 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-8 py-2.5 me-2 mb-2 dark:focus:ring-orange-900">
              Précommander
            </span> 
          </button>
        </div>
      ...
      {poppupVisible && (
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-75 z-50">
          <Poppup trigger={poppupVisible} setTrigger={setPoppupVisible}>
            <h2 className="text-orange-500">Numéro de Téléphone :</h2>
            <br />
            <input className="border border-orange-300" type="text" placeholder="Entrez votre numéro..." />
            <br /><br />
            <ColorPicker />
            <br /><br />
            <Memory />
