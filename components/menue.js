    ...
    <div className="relative max-w-screen justify-between flex flex-wrap items-center ml-6">
      ...
      <Navbar fluid={true} rounded={true}>
        ...
        <Navbar.Collapse className="sm:flex ml-40">
          ...
          <Navbar.Link href="/navbars">iPhone 15</Navbar.Link>
          <Navbar.Link href="/navbars">iPad Pro Max</Navbar.Link>
          <Navbar.Link href="/navbars">Galaxy Z Fold</Navbar.Link>
          <Navbar.Link href="/navbars">Galaxy Z Flip</Navbar.Link>
        </Navbar.Collapse>
